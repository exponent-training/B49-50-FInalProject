	...
	public void generateUserReportInService(String format) throws JRException {
		...
		try {
			...
			if (format.equalsIgnoreCase("html")) {
				...
				JasperExportManager.exportReportToHtmlFile(jasperPrint, "C:\\MyHospitalReports\\User.html");
			} else if (format.equalsIgnoreCase("pdf")) {

				JasperExportManager.exportReportToPdfFile(jasperPrint, "C:\\MyHospitalReports\\User.pdf");
				...
				csvfile.setExporterOutput(new SimpleWriterExporterOutput("C:\\MyHospitalReports\\User.csv"));
